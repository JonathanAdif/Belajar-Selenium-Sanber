...
class TestLogin(unittest.TestCase): 
    ...
    def test_d_failed_regis_empty_password(self): 
        # steps
        browser = self.browser #buka web browser
        browser.get("http://barru.pythonanywhere.com/daftar") # buka situs
        time.sleep(3)
        browser.find_element(By.ID,"signUp").click()
        browser.find_element(By.ID,"name_register").send_keys("jona") # isi email
        time.sleep(1)
        browser.find_element(By.ID,"email_register").send_keys("jona50@gmail.com") # isi email
        time.sleep(1)
    ...
    def test_e_failed_regis_unvalid_email(self): 
        # steps
        browser = self.browser #buka web browser
        browser.get("http://barru.pythonanywhere.com/daftar") # buka situs
        time.sleep(3)
        ...
        browser.find_element(By.ID,"name_register").send_keys("jona") # isi email
        time.sleep(1)
        browser.find_element(By.ID,"email_register").send_keys("jona50gmail.com") # isi email
        time.sleep(1)
        browser.find_element(By.ID,"password_register").send_keys("liverpool") # isi password
        time.sleep(1)
        browser.find_element(By.ID,"signup_register").click() # klik tombol sign in
        time.sleep(1)
